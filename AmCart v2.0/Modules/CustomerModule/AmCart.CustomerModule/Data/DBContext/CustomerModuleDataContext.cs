...
namespace AmCart.CustomerModule.Data.DBContext
{
    public class CustomerModuleDataContext : DbContext
    {
        public DbSet<Customer> Customers { get; set; }


        public CustomerModuleDataContext(DbContextOptions options) : base(options)
        {
        }
